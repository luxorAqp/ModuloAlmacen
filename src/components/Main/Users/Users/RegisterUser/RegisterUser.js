        ...
        <div className="containerRegUser">
          ...
          <form action="#">
            <div className="detailsRegUser">
              ...
              <div className="divRegUser">
                <span className="spanRegUser">Perfil de usuario</span>
                <input
                  type="text"
                  placeholder="Elige el nivel de usuario"
                  required
                />
              </div>
              ...
              <div className="divRegUser">
                <span className="spanRegUser">Sede</span>
                <input
                  type="text"
                  placeholder="Ingrese la sede del usuario"
                  required
                />
              </div>
            </div>
